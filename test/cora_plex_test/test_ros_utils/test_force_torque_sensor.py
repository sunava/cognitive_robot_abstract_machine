...
from cora_plex.ros_utils.force_torque_sensor import (
    ForceTorqueSensor,
...
class ForceTorqueSensorTestCase(unittest.TestCase):
    ...
    @patch("cora_plex.ros_utils.force_torque_sensor.World")
    @patch("cora_plex.ros_utils.force_torque_sensor.create_publisher")
