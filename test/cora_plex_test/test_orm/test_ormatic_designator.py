...
from cora_plex.orm.ormatic_interface import *  # type: ignore
...
def test_plan_serialization(cora_plex_testing_session, simple_plan):
    session = cora_plex_testing_session
...
def test_replay_simple_plan(cora_plex_testing_session, simple_plan):
...
def test_execution_data_of_complex_plan(cora_plex_testing_session, complex_plan):
...
def test_replay_complex_plan_from_db(cora_plex_testing_session, complex_plan):
