...
12. **[Attaching an RDR to a Function with @rdr](rdr_decorator.md)**: Wrap any annotated function with a live RDR classifier — the case type is generated from the function's own signature.
