...
move_torso_low = SequentialPlan(
    context,
    ParkArmsActionDescription(Arms.BOTH),
    MoveTorsoActionDescription(TorsoState.LOW),
)
move_torso_mid = SequentialPlan(
    context,
    ParkArmsActionDescription(Arms.BOTH),
