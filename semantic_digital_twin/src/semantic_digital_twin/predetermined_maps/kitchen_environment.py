...
slam = HomogeneousTransformationMatrix.from_xyz_rpy(x=0.33, y=0.28, yaw=0.10707963267)
...
class KitchenEnvironment:
    ...
    def _build_environment_walls(self, world: World):
        ...
        root_C_north_west_wall = FixedConnection(
            ...
            parent_T_connection_expression=slam @ HomogeneousTransformationMatrix.from_xyz_rpy(
    ...
    def _build_environment_furniture(self, world: World):
        ...
        with world.modify_world():
            ...
            counterTop = CounterTop.create_with_new_body_in_world(
                ...
                world_root_T_self= slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=1.859, y=-2.181, z=0.2725),
            ...
            table = Table.create_with_new_body_in_world(
                ...
                world_root_T_self=slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=3.545, y=0.426, z=0.4225),
            ...
            sofa = Sofa.create_with_new_body_in_world(
                ...
                world_root_T_self=slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=3.60, y=1.20, z=0.34),
            ...
            lowerTable = Table.create_with_new_body_in_world(
                ...
                world_root_T_self=slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=4.22, y=2.22, z=0.22),
            ...
            desk = Table.create_with_new_body_in_world(
                ...
                world_root_T_self=slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=0.05, y=1.28, z=0.375),
            ...
            cooking_table = Table.create_with_new_body_in_world(
                ...
                world_root_T_self=slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=1.325, y=5.99, z=0.355),
    ...
    def _build_environment_rooms(self, world: World):
        ...
        with world.modify_world():
            ...
            kitchen_floor = Floor.create_with_new_body_from_polytope_in_world(
                ...
                world_root_T_self= slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=2.317, y=-0.843),
            )
            ...
            living_room_floor = Floor.create_with_new_body_from_polytope_in_world(
                ...
                world_root_T_self= slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=2.317, y=2.3095),
            )
            ...
            bed_room_floor = Floor.create_with_new_body_from_polytope_in_world(
                ...
                world_root_T_self= slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=0.96, y=4.96),
            )
            ...
            office_floor = Floor.create_with_new_body_from_polytope_in_world(
                ...
                world_root_T_self= slam @ HomogeneousTransformationMatrix.from_xyz_rpy(x=3.56, y=4.96),
            )
