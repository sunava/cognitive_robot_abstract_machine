...
class ConditionNotSatisfiedDAO(
    Base, DataAccessObject[coraplex.exceptions.ConditionNotSatisfied]
):
...
class ActionDescriptionDAO(
    DesignatorDAO,
    DataAccessObject[coraplex.robot_plans.actions.base.ActionDescription],
):
...
class MotionDidNotFinishDAO(
    Base, DataAccessObject[coraplex.exceptions.MotionDidNotFinish]
):
