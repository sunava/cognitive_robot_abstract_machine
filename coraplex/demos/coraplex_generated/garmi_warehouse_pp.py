"""
mydemo5 — a working version of the Plan Builder milk demo (Garmi, warehouse6).
...
"""How far in front of a grasp pose the robot stands, within the Garmi's reach."""
...
"""Where the Garmi starts, on the open hall floor."""


def build_world() -> World:
    """The hall with the Garmi and the milk standing free in front of it."""
    return WorldSpecification(
        robots=[
            RobotSpecification(
                semantic_annotation_type=Garmi,
...
def build_plan(world: World, robot: Garmi):
