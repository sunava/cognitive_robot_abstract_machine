...
classes |= set(classes_of_package(coraplex))
classes |= set(classes_of_package(giskardpy))
classes -= set(classes_of_package(giskardpy.qp.solvers))
classes -= set(classes_of_module(coraplex.locations.costmaps))
classes -= set(classes_of_module(coraplex.orm.ormatic_interface))
...
path = os.path.abspath(os.path.join(os.getcwd(), "../src/coraplex/orm/"))
