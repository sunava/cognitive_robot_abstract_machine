...
from cora_plex.robot_plans import MoveToolCenterPointMotion
...
from cora_plex.alternative_motion_mapping import AlternativeMotion
...
logger = logging.getLogger("cora_plex")
...
def visibility_validator(
    ...
    if isinstance(object_or_pose, Pose):
        gen_body = Body(
            name=PrefixedName("vist_test_obj", "cora_plex"),
