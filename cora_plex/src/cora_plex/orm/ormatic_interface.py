...
import builtins
import cora_plex.alternative_motion_mapping
import cora_plex.alternative_motion_mappings.hsrb_motion_mapping
import cora_plex.alternative_motion_mappings.stretch_motion_mapping
import cora_plex.alternative_motion_mappings.tiago_motion_mapping
import cora_plex.datastructures.dataclasses
import cora_plex.datastructures.execution_data
import cora_plex.datastructures.grasp
import cora_plex.datastructures.trajectory
import cora_plex.exceptions
import cora_plex.language
import cora_plex.locations.locations
import cora_plex.motion_executor
import cora_plex.orm.model
import cora_plex.perception
import cora_plex.plans.designator
import cora_plex.plans.failures
import cora_plex.plans.plan_callbacks
import cora_plex.plans.plan_entity
import cora_plex.plans.plan_node
import cora_plex.robot_plans.actions.base
import cora_plex.robot_plans.actions.composite.facing
import cora_plex.robot_plans.actions.composite.searching
import cora_plex.robot_plans.actions.composite.tool_based
import cora_plex.robot_plans.actions.composite.transporting
import cora_plex.robot_plans.actions.core.container
import cora_plex.robot_plans.actions.core.misc
import cora_plex.robot_plans.actions.core.navigation
import cora_plex.robot_plans.actions.core.pick_up
import cora_plex.robot_plans.actions.core.placing
import cora_plex.robot_plans.actions.core.robot_body
import cora_plex.robot_plans.motions.base
import cora_plex.robot_plans.motions.container
import cora_plex.robot_plans.motions.gripper
import cora_plex.robot_plans.motions.misc
import cora_plex.robot_plans.motions.navigation
import cora_plex.robot_plans.motions.robot_body
import cora_plex.view_manager
import datetime
import enum
...
class Base(DeclarativeBase):
    type_mappings = {
        ...
        numpy.ndarray: cora_plex.orm.model.NumpyType,
    }
...
class AlternativeMotionDAO(
    Base, DataAccessObject[cora_plex.alternative_motion_mapping.AlternativeMotion]
):
...
class ClosestPointsDAO(
    ...
    root_P_point_on_body_a: Mapped[numpy.ndarray] = mapped_column(
        cora_plex.orm.model.NumpyType, nullable=False, use_existing_column=True
    )
...
class ConditionNotSatisfiedDAO(
    Base, DataAccessObject[cora_plex.exceptions.ConditionNotSatisfied]
):
...
class ContextIsUnavailableDAO(
    Base, DataAccessObject[cora_plex.exceptions.ContextIsUnavailable]
):
...
class DesignatorDAO(Base, DataAccessObject[cora_plex.plans.designator.Designator]):
...
class ActionDescriptionDAO(
    DesignatorDAO,
    DataAccessObject[cora_plex.robot_plans.actions.base.ActionDescription],
):
...
class CarryActionDAO(
    ...
    DataAccessObject[cora_plex.robot_plans.actions.core.robot_body.CarryAction],
):
    ...
    arm: Mapped[cora_plex.datastructures.enums.Arms] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=False,
        use_existing_column=True,
    )
    tip_axis: Mapped[typing.Optional[cora_plex.datastructures.enums.AxisIdentifier]] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=True,
            use_existing_column=True,
    ...
    root_axis: Mapped[
        typing.Optional[cora_plex.datastructures.enums.AxisIdentifier]
    ] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=True,
        use_existing_column=True,
...
class CloseActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.container.CloseAction],
):
...
class CuttingActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.composite.tool_based.CuttingAction],
):
...
class BaseMotionDAO(
    DesignatorDAO, DataAccessObject[cora_plex.robot_plans.motions.base.BaseMotion]
):
...
class ClosingMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.container.ClosingMotion],
):
...
class DetectActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.misc.DetectAction],
):
    ...
    technique: Mapped[cora_plex.datastructures.enums.DetectionTechnique] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=False,
            use_existing_column=True,
    ...
    state: Mapped[typing.Optional[cora_plex.datastructures.enums.DetectionState]] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=True,
            use_existing_column=True,
...
class DetectingMotionDAO(
    BaseMotionDAO, DataAccessObject[cora_plex.robot_plans.motions.misc.DetectingMotion]
):
...
class EfficientTransportActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[
        cora_plex.robot_plans.actions.composite.transporting.EfficientTransportAction
    ],
):
...
class ExecutionDataDAO(
    Base, DataAccessObject[cora_plex.datastructures.execution_data.ExecutionData]
):
    ...
    execution_end_world_state: Mapped[typing.Optional[numpy.ndarray]] = mapped_column(
        cora_plex.orm.model.NumpyType, nullable=True, use_existing_column=True
    )
...
class ExecutionEnvironmentDAO(
    Base, DataAccessObject[cora_plex.motion_executor.ExecutionEnvironment]
):
    ...
    execution_type: Mapped[cora_plex.datastructures.enums.ExecutionType] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=False,
            use_existing_column=True,
...
class FaceAtActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.composite.facing.FaceAtAction],
):
...
class FollowToolCenterPointPathActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[
        cora_plex.robot_plans.actions.core.robot_body.FollowToolCenterPointPathAction
    ],
):
...
class GraspDescriptionDAO(
    Base, DataAccessObject[cora_plex.datastructures.grasp.GraspDescription]
):
    ...
    approach_direction: Mapped[cora_plex.datastructures.enums.ApproachDirection] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=False,
            use_existing_column=True,
    ...
    vertical_alignment: Mapped[cora_plex.datastructures.enums.VerticalAlignment] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=False,
            use_existing_column=True,
...
class GraspingActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.pick_up.GraspingAction],
):
...
class LocationDAO(Base, DataAccessObject[cora_plex.locations.locations.Location]):
...
class AccessingLocationDAO(
    LocationDAO, DataAccessObject[cora_plex.locations.locations.AccessingLocation]
):
...
class CostmapLocationDAO(
    LocationDAO, DataAccessObject[cora_plex.locations.locations.CostmapLocation]
):
    ...
    reachable_arm: Mapped[typing.Optional[cora_plex.datastructures.enums.Arms]] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=True,
            use_existing_column=True,
...
class GiskardLocationDAO(
    LocationDAO, DataAccessObject[cora_plex.locations.locations.GiskardLocation]
):
...
class LookAtActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.navigation.LookAtAction],
):
...
class LookingMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.robot_body.LookingMotion],
):
...
class MixingActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.composite.tool_based.MixingAction],
):
...
class MotionDidNotFinishDAO(
    Base, DataAccessObject[cora_plex.exceptions.MotionDidNotFinish]
):
...
class MotionExecutorDAO(
    Base, DataAccessObject[cora_plex.motion_executor.MotionExecutor]
):
...
class MoveAndPickUpActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[
        cora_plex.robot_plans.actions.composite.transporting.MoveAndPickUpAction
    ],
):
...
class MoveAndPlaceActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[
        cora_plex.robot_plans.actions.composite.transporting.MoveAndPlaceAction
    ],
):
...
class MoveGripperMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.gripper.MoveGripperMotion],
):
    ...
    gripper: Mapped[cora_plex.datastructures.enums.Arms] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=False,
        use_existing_column=True,
    )
...
class MoveJointsMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.robot_body.MoveJointsMotion],
):
...
class MoveMotionDAO(
    BaseMotionDAO, DataAccessObject[cora_plex.robot_plans.motions.navigation.MoveMotion]
):
...
class HSRBMoveMotionDAO(
    MoveMotionDAO,
    DataAccessObject[
        cora_plex.alternative_motion_mappings.hsrb_motion_mapping.HSRBMoveMotion
    ],
):
...
class MoveTCPWaypointsMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.gripper.MoveTCPWaypointsMotion],
):
    ...
    movement_type: Mapped[cora_plex.datastructures.enums.WaypointsMovementType] = (
        mapped_column(
            krrood.ormatic.custom_types.PolymorphicEnumType,
            nullable=False,
            use_existing_column=True,
...
class MoveToolCenterPointMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.gripper.MoveToolCenterPointMotion],
):
    ...
    movement_type: Mapped[
        typing.Optional[cora_plex.datastructures.enums.MovementType]
    ] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=True,
        use_existing_column=True,
...
class MoveTorsoActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.robot_body.MoveTorsoAction],
):
...
class NavigateActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.navigation.NavigateAction],
):
...
class OpenActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.container.OpenAction],
):
...
class OpeningMotionDAO(
    BaseMotionDAO,
    DataAccessObject[cora_plex.robot_plans.motions.container.OpeningMotion],
):
...
class ParkArmsActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.robot_body.ParkArmsAction],
):
...
class PerceptionQueryDAO(Base, DataAccessObject[cora_plex.perception.PerceptionQuery]):
...
class PickAndPlaceActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[
        cora_plex.robot_plans.actions.composite.transporting.PickAndPlaceAction
    ],
):
...
class PickUpActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.pick_up.PickUpAction],
):
...
class PlaceActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.placing.PlaceAction],
):
...
class PlanEdgeDAO(Base, DataAccessObject[cora_plex.orm.model.PlanEdge]):
...
class PlanEntityDAO(Base, DataAccessObject[cora_plex.plans.plan_entity.PlanEntity]):
...
class ContextDAO(
    PlanEntityDAO, DataAccessObject[cora_plex.datastructures.dataclasses.Context]
):
...
class PlanCallbackDAO(
    PlanEntityDAO, DataAccessObject[cora_plex.plans.plan_callbacks.PlanCallback]
):
...
class PlanFailureDAO(Base, DataAccessObject[cora_plex.plans.failures.PlanFailure]):
...
class AllChildrenFailedDAO(
    PlanFailureDAO, DataAccessObject[cora_plex.plans.failures.AllChildrenFailed]
):
...
class BodyUnfetchableDAO(
    PlanFailureDAO, DataAccessObject[cora_plex.plans.failures.BodyUnfetchable]
):
...
class ConfigurationNotReachedDAO(
    PlanFailureDAO, DataAccessObject[cora_plex.plans.failures.ConfigurationNotReached]
):
...
class NavigationGoalNotReachedErrorDAO(
    PlanFailureDAO,
    DataAccessObject[cora_plex.plans.failures.NavigationGoalNotReachedError],
):
...
class PerceptionObjectNotFoundDAO(
    PlanFailureDAO, DataAccessObject[cora_plex.plans.failures.PerceptionObjectNotFound]
):
...
class PlanNodeDAO(PlanEntityDAO, DataAccessObject[cora_plex.plans.plan_node.PlanNode]):
    ...
    status: Mapped[cora_plex.datastructures.enums.TaskStatus] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=False,
        use_existing_column=True,
    )
...
class DesignatorNodeDAO(
    PlanNodeDAO, DataAccessObject[cora_plex.plans.plan_node.DesignatorNode]
):
...
class ActionNodeDAO(
    DesignatorNodeDAO, DataAccessObject[cora_plex.plans.plan_node.ActionNode]
):
...
class MotionNodeDAO(
    DesignatorNodeDAO, DataAccessObject[cora_plex.plans.plan_node.MotionNode]
):
...
class LanguageNodeDAO(PlanNodeDAO, DataAccessObject[cora_plex.language.LanguageNode]):
...
class CodeNodeDAO(LanguageNodeDAO, DataAccessObject[cora_plex.language.CodeNode]):
...
class ExecutesInParallelDAO(
    LanguageNodeDAO, DataAccessObject[cora_plex.language.ExecutesInParallel]
):
...
class ParallelNodeDAO(
    ExecutesInParallelDAO, DataAccessObject[cora_plex.language.ParallelNode]
):
...
class ExecutesSequentiallyDAO(
    LanguageNodeDAO, DataAccessObject[cora_plex.language.ExecutesSequentially]
):
...
class MonitorNodeDAO(
    ExecutesSequentiallyDAO, DataAccessObject[cora_plex.language.MonitorNode]
):
    ...
    behavior: Mapped[cora_plex.datastructures.enums.MonitorBehavior] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=False,
        use_existing_column=True,
    )
...
class PoseTrajectoryDAO(
    Base, DataAccessObject[cora_plex.datastructures.trajectory.PoseTrajectory]
):
...
class PouringActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.composite.tool_based.PouringAction],
):
...
class PreferredGraspAlignmentDAO(
    Base, DataAccessObject[cora_plex.datastructures.grasp.PreferredGraspAlignment]
):
...
class ReachActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.pick_up.ReachAction],
):
...
class ReachMotionDAO(
    BaseMotionDAO, DataAccessObject[cora_plex.robot_plans.motions.gripper.ReachMotion]
):
    ...
    movement_type: Mapped[cora_plex.datastructures.enums.MovementType] = mapped_column(
        krrood.ormatic.custom_types.PolymorphicEnumType,
        nullable=False,
        use_existing_column=True,
    )
...
class RepeatNodeDAO(
    ExecutesSequentiallyDAO, DataAccessObject[cora_plex.language.RepeatNode]
):
...
class RobotInCollisionDAO(
    PlanFailureDAO, DataAccessObject[cora_plex.plans.failures.RobotInCollision]
):
...
class SearchActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.composite.searching.SearchAction],
):
...
class SequentialNodeDAO(
    ExecutesSequentiallyDAO, DataAccessObject[cora_plex.language.SequentialNode]
):
...
class SetGripperActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[cora_plex.robot_plans.actions.core.robot_body.SetGripperAction],
):
...
class StretchCloseDAO(
    ClosingMotionDAO,
    DataAccessObject[
        cora_plex.alternative_motion_mappings.stretch_motion_mapping.StretchClose
    ],
):
...
class StretchMoveSimDAO(
    MoveMotionDAO,
    DataAccessObject[
        cora_plex.alternative_motion_mappings.stretch_motion_mapping.StretchMoveSim
    ],
):
...
class StretchMoveToolCenterPointDAO(
    ...
    DataAccessObject[
        cora_plex.alternative_motion_mappings.stretch_motion_mapping.StretchMoveToolCenterPoint
    ],
):
...
class TiagoMoveSimDAO(
    MoveMotionDAO,
    DataAccessObject[
        cora_plex.alternative_motion_mappings.tiago_motion_mapping.TiagoMoveSim
    ],
):
...
class TransportActionDAO(
    ActionDescriptionDAO,
    DataAccessObject[
        cora_plex.robot_plans.actions.composite.transporting.TransportAction
    ],
):
...
class TryAllNodeDAO(
    ExecutesInParallelDAO, DataAccessObject[cora_plex.language.TryAllNode]
):
...
class TryInOrderNodeDAO(
    ExecutesSequentiallyDAO, DataAccessObject[cora_plex.language.TryInOrderNode]
):
...
class UnderspecifiedNodeDAO(
    PlanNodeDAO, DataAccessObject[cora_plex.plans.plan_node.UnderspecifiedNode]
):
...
class ViewManagerDAO(Base, DataAccessObject[cora_plex.view_manager.ViewManager]):
