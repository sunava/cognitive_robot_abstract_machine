...
if TYPE_CHECKING:
    from cora_plex.validation.goal_validator import MultiJointPositionGoalValidator
    from cora_plex.language import LanguageNode
    from semantic_digital_twin.datastructures.definitions import StaticJointState
    from cora_plex.robot_plans.actions.composite.searching import SearchAction
