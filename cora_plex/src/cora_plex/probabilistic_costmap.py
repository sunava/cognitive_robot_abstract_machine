...
from cora_plex.tf_transformations import quaternion_from_euler
from random_events.interval import closed_open
from typing_extensions import Optional, Type

from cora_plex.locations.costmaps import Costmap, OccupancyCostmap, VisibilityCostmap
import matplotlib.colorbar
from cora_plex.datastructures.pose import PoseStamped
from cora_plex.ros import create_publisher, Duration
...
class ProbabilisticCostmap:
    ...
    @cached_property
    def publisher(self):
        return create_publisher("/cora_plex/viz_marker", MarkerArray, queue_size=10)
