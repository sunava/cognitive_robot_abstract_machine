...
from cora_plex.datastructures.enums import FilterConfig
from cora_plex.filter import Butterworth
from cora_plex.ros import Time
from cora_plex.ros import create_publisher, create_subscriber
...
class ForceTorqueSensorSimulated:
    ...
    def __init__(
        self, joint_name, world: World, fts_topic="/cora_plex/fts", interval=0.1
    ):
        """
        The given joint_name has to be part of :py:attr:`~cora_plex.world.World.robot` otherwise a
