...
Panels.define('robot-scene', function (root, bus) {
  ...
  // this page's bundle signature no longer matches what the bridge would bundle now
  // (see LiveMode.needsLiveSceneReload): rebundle the live scene, then reload onto it
