...
(function (global) {
  ...
  global.PlanConstraints = {
    ...
    /* The switches a step's action is given for these constraints, as the running scene
       reads them -- the same names the generated file passes as keyword arguments. */
    stepSwitches: function (constraints) {
      const switches = {};
      constraints.forEach(function (constraint) {
        if (constraint.stepArgument) switches[constraint.stepArgument] = true;
      });
      return switches;
    },
