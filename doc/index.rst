...
-  `Cora Plex <https://cram2.github.io/cognitive_robot_abstract_machine/cora_plex>`__:
...
| [4] J. Dech, A. Bassiouny, T. Schierenbeck, V. Hassouna, L. Krohm, and
  D. Prüsser, Cora Plex: A Python framework for cognition-enbabled robtics.
  (2025). [Online]. Available: https://github.com/cram2/cora_plex
